...
class PujasboeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        full_url = urllib.parse.urljoin('https://' + self.allowed_domains[0], url.extract()[0])
    ...
    def parse_results(self, response):
        ...
        for url in links_pujas:
            item = PypujasItem()
            full_url = urllib.parse.urljoin('https://' + self.allowed_domains[0], url.extract())
    ...
    def parse_table_puja(self, response):
        ...
        print('TABLE ROWS: ', table_rows) # TODO empty
